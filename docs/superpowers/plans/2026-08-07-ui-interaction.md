...
- [x] **Step 2: 先写测试** `src/utils/__tests__/position.test.ts`
...
- [x] **Step 1: 先写测试** `src/utils/__tests__/dateValidation.test.ts`
...
- [x] **Step 3: handleCalc 前校验（保留现有 toast 兜底）**
