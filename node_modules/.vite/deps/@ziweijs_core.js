...
// node_modules/@ziweijs/core/dist/rslib-runtime.js
...
// node_modules/@ziweijs/i18n/dist/index.js
var DEFAULT_FALLBACK_TEXT = "Missing translation";
...
var sanitizeFallbacks = (value, available) => {
  const unique = /* @__PURE__ */ new Set();
  for (const candidate of toArray(value)) if (available.includes(candidate) && !unique.has(candidate)) unique.add(candidate);
  return Array.from(unique);
};
var isRecord = (value) => "object" == typeof value && null !== value;
var resolveSegments = (resource, segments) => {
  let value = resource;
...
var buildSearchOrder = (primary, fallbacks) => {
  const result = [
    primary
  ];
...
function createI18n({ lang, resources, fallback, fallbackLanguages, separator = DEFAULT_SEPARATOR, onMissing }) {
  ...
  return {
    $t(key, defaultValue) {
      ...
      onMissing == null ? void 0 : onMissing({
        key,
    ...
    has(key, lang2) {
      const searchOrder = lang2 ? [
        ensureLanguageExists(lang2)
...
var FestivalType = ((FestivalType2) => {
...
var HideHeavenStemType = ((HideHeavenStemType2) => {
...
var _Animal = class _Animal extends LoopTyme {
...
var Animal = _Animal;
var _TwentyEightStar = class _TwentyEightStar extends LoopTyme {
  constructor(indexOrName) {
...
var _SevenStar = class _SevenStar extends LoopTyme {
  constructor(indexOrName) {
...
var _Week = class _Week extends LoopTyme {
  constructor(indexOrName) {
...
var Week = _Week;
var _Land = class _Land extends LoopTyme {
  constructor(indexOrName) {
...
var Land = _Land;
var _Direction = class _Direction extends LoopTyme {
  constructor(indexOrName) {
...
var _Zone = class _Zone extends LoopTyme {
  constructor(indexOrName) {
...
var Zone = _Zone;
var _Beast = class _Beast extends LoopTyme {
  constructor(indexOrName) {
...
var Beast = _Beast;
var _Luck = class _Luck extends LoopTyme {
  constructor(indexOrName) {
...
var Luck = _Luck;
var _Constellation = class _Constellation extends LoopTyme {
  constructor(indexOrName) {
...
var _Duty = class _Duty extends LoopTyme {
  constructor(indexOrName) {
...
var Duty = _Duty;
var _Element = class _Element extends LoopTyme {
  constructor(indexOrName) {
...
var _God = class _God extends LoopTyme {
  constructor(indexOrName) {
...
__publicField(_Phase, "NAMES", ["新月", "蛾眉月", "上弦月", "盈凸月", "满月", "亏凸月", "下弦月", "残月"]);
var Phase = _Phase;
...
var _Sixty = class _Sixty extends LoopTyme {
  constructor(indexOrName) {
...
var Sixty = _Sixty;
var _Sound = class _Sound extends LoopTyme {
  constructor(indexOrName) {
...
var Sound = _Sound;
var _Taboo = class _Taboo extends LoopTyme {
  constructor(indexOrName) {
...
var Taboo = _Taboo;
var _Ten = class _Ten extends LoopTyme {
  constructor(indexOrName) {
...
var Ten = _Ten;
var _Terrain = class _Terrain extends LoopTyme {
  constructor(indexOrName) {
...
var _Twenty = class _Twenty extends LoopTyme {
  constructor(indexOrName) {
...
var Twenty = _Twenty;
var _Zodiac = class _Zodiac extends LoopTyme {
  constructor(indexOrName) {
...
var Zodiac = _Zodiac;
var _EarthBranch = class _EarthBranch extends LoopTyme {
  constructor(indexOrName) {
...
var _HeavenStem = class _HeavenStem extends LoopTyme {
  constructor(indexOrName) {
...
var _PengZuHeavenStem = class _PengZuHeavenStem extends LoopTyme {
  constructor(indexOrName) {
...
var _PengZuEarthBranch = class _PengZuEarthBranch extends LoopTyme {
  constructor(indexOrName) {
...
var _TenStar = class _TenStar extends LoopTyme {
  constructor(indexOrName) {
...
var _SixStar = class _SixStar extends LoopTyme {
  constructor(indexOrName) {
...
var _MinorRen = class _MinorRen extends LoopTyme {
  constructor(indexOrName) {
...
var _SixtyCycle = class _SixtyCycle extends LoopTyme {
  constructor(indexOrName) {
...
var _Dog = class _Dog extends LoopTyme {
  constructor(indexOrName) {
...
var _PlumRain = class _PlumRain extends LoopTyme {
  constructor(indexOrName) {
...
var _FetusHeavenStem = class _FetusHeavenStem extends LoopTyme {
  constructor(index) {
...
var _FetusEarthBranch = class _FetusEarthBranch extends LoopTyme {
  constructor(index) {
...
var _Nine = class _Nine extends LoopTyme {
  constructor(indexOrName) {
...
var _Phenology = class _Phenology extends LoopTyme {
...
__publicField(_Phenology, "NAMES", ["蚯蚓结", "麋角解", "水泉动", "雁北乡", "鹊始巢", "雉始雊", "鸡始乳", "征鸟厉疾", "水泽腹坚", "东风解冻", "蛰虫始振", "鱼陟负冰", "獭祭鱼", "候雁北", "草木萌动", "桃始华", "仓庚鸣", "鹰化为鸠", "玄鸟至", "雷乃发声", "始电", "桐始华", "田鼠化为鴽", "虹始见", "萍始生", "鸣鸠拂其羽", "戴胜降于桑", "蝼蝈鸣", "蚯蚓出", "王瓜生", "苦菜秀", "靡草死", "麦秋至", "螳螂生", "鵙始鸣", "反舌无声", "鹿角解", "蜩始鸣", "半夏生", "温风至", "蟋蟀居壁", "鹰始挚", "腐草为萤", "土润溽暑", "大雨行时", "凉风至", "白露降", "寒蝉鸣", "鹰乃祭鸟", "天地始肃", "禾乃登", "鸿雁来", "玄鸟归", "群鸟养羞", "雷始收声", "蛰虫坯户", "水始涸", "鸿雁来宾", "雀入大水为蛤", "菊有黄花", "豺乃祭兽", "草木黄落", "蛰虫咸俯", "水始冰", "地始冻", "雉入大水为蜃", "虹藏不见", "天气上升地气下降", "闭塞而成冬", "鹖鴠不鸣", "虎始交", "荔挺出"]);
var Phenology = _Phenology;
var _ThreePhenology = class _ThreePhenology extends LoopTyme {
  constructor(indexOrName) {
...
var _Dipper = class _Dipper extends LoopTyme {
  constructor(indexOrName) {
...
var _NineStar = class _NineStar extends LoopTyme {
  constructor(indexOrName) {
...
var _TwelveStar = class _TwelveStar extends LoopTyme {
  constructor(indexOrName) {
...
var _Ecliptic = class _Ecliptic extends LoopTyme {
  constructor(indexOrName) {
...
var _LunarYear = class _LunarYear extends AbstractTyme {
  constructor(year) {
    super();
    __publicField(this, "year");
    _LunarYear.init();
  ...
  next(n) {
    return _LunarYear.fromYear(this.year + n);
  }
  getLeapMonth() {
    if (this.year === -1) {
      return 11;
    ...
    for (let i = 0, j = _LunarYear.LEAP.length; i < j; i++) {
      if (_LunarYear.LEAP[i].indexOf(this.year) > -1) {
        return i + 1;
      }
    }
    return 0;
...
var _LunarSeason = class _LunarSeason extends LoopTyme {
  constructor(indexOrName) {
...
var _FetusMonth = class _FetusMonth extends LoopTyme {
  constructor(indexOrName) {
...
var _LunarMonth = class _LunarMonth extends AbstractTyme {
  constructor(year, month, cache) {
    ...
    if (cache) {
      ...
      const t = _LunarMonth.numeric(month, "lunar month");
      if (t === 0 || t > 12 || t < -12) {
  ...
  static fromYm(year, month) {
    ...
    const cache = _LunarMonth.cache[key];
    if (cache) {
      m = new _LunarMonth(0, 0, cache);
    } else {
      m = new _LunarMonth(year, month);
      _LunarMonth.cache[key] = [m.getYear(), m.getMonthWithLeap(), m.getDayCount(), m.getIndexInYear(), m.getFirstJulianDay().getDay()];
    }
    return m;
  }
  getLunarYear() {
  ...
  getName() {
    return (this.leap ? "闰" : "") + _LunarMonth.NAMES[this.month - 1];
  }
  toString() {
...
var _LunarWeek = class _LunarWeek extends AbstractTyme {
  constructor(year, month, index, start) {
    super();
    __publicField(this, "month");
    __publicField(this, "index");
    __publicField(this, "start");
    const i = _LunarWeek.numeric(index, "lunar week index");
    if (i < 0 || i > 5) {
  ...
  getName() {
    return _LunarWeek.NAMES[this.index];
  }
  toString() {
  ...
  next(n) {
    ...
    if (n === 0) {
      return _LunarWeek.fromYm(this.getYear(), this.getMonth(), this.index, startIndex);
    }
    let d = this.index + n;
    let m = this.month;
    if (n > 0) {
...
var _LunarDay = class _LunarDay extends AbstractTyme {
  constructor(year, month, day) {
    super();
    __publicField(this, "month");
    __publicField(this, "day");
    __publicField(this, "solarDay");
    __publicField(this, "sixtyCycleDay");
    const m = LunarMonth.fromYm(year, month);
  ...
  getName() {
    return _LunarDay.NAMES[this.day - 1];
  }
  toString() {
    return this.month.toString() + this.getName();
  }
  ...
  getNineStar() {
    ...
    const dongZhiSolar = dongZhi.getSolarDay();
    const xiaZhiSolar = dongZhi.next(12).getSolarDay();
    const dongZhiSolar2 = dongZhi.next(24).getSolarDay();
...
var SixtyCycleDay = class _SixtyCycleDay extends AbstractTyme {
  ...
  static fromSolarDay(solarDay) {
    ...
    const springSolarDay = SolarTerm.fromIndex(solarYear, 3).getSolarDay();
    ...
    return new _SixtyCycleDay(solarDay, new SixtyCycleMonth(SixtyCycleYear.fromYear(lunarYear.getYear()), LunarMonth.fromYm(solarYear, 1).getSixtyCycle().next(~~Math.floor(index * 0.5))), lunarDay.getSixtyCycle());
  }
  getSolarDay() {
    return this.solarDay;
  }
...
var _LunarHour = class _LunarHour extends AbstractTyme {
  constructor(year, month, day, hour, minute, second) {
    ...
    __publicField(this, "solarTime");
    __publicField(this, "sixtyCycleHour");
    const h = _LunarHour.numeric(hour, "hour");
    if (h < 0 || h > 23) {
      throw new Error(`illegal hour: ${hour}`);
    }
    const m = _LunarHour.numeric(minute, "minute");
    if (m < 0 || m > 59) {
  ...
  next(n) {
    if (n == 0) {
      return _LunarHour.fromYmdHms(this.getYear(), this.getMonth(), this.getDay(), this.hour, this.minute, this.second);
    }
    ...
    return _LunarHour.fromYmdHms(d.getYear(), d.getMonth(), d.getDay(), hour, this.minute, this.second);
  }
  isBefore(target) {
  ...
  getNineStar() {
    ...
    const dongZhi = SolarTerm.fromIndex(solar.getYear(), 0);
    const earthBranchIndex = this.getIndexInDay() % 12;
    let index = [8, 5, 2][this.day.getSixtyCycle().getEarthBranch().getIndex() % 3];
    if (!solar.isBefore(dongZhi.getJulianDay().getSolarDay()) && solar.isBefore(dongZhi.next(12).getJulianDay().getSolarDay())) {
      index = 8 + earthBranchIndex - index;
    } else {
      index -= earthBranchIndex;
...
var _JulianDay = class _JulianDay extends AbstractTyme {
  constructor(day) {
    super();
    __publicField(this, "day");
...
var _ShouXingUtil = class _ShouXingUtil {
  static decode(s) {
    const o = "0000000000";
    const o2 = o + o;
    s = s.replace(/J/g, "00");
...
__publicField(_ShouXingUtil, "SECOND_PER_RAD", 648e3 / Math.PI);
...
var _SolarTerm = class _SolarTerm extends LoopTyme {
  constructor(year, indexOrName) {
    super(_SolarTerm.NAMES, indexOrName);
    __publicField(this, "year");
    __publicField(this, "cursoryJulianDay");
    let y = _SolarTerm.numeric(year, "lunar year");
    if (typeof indexOrName === "number") {
...
var SolarYear = class _SolarYear extends AbstractTyme {
  constructor(year) {
    super();
    __publicField(this, "year");
  ...
  next(n) {
    return _SolarYear.fromYear(this.year + n);
  }
  getMonths() {
    const l = [];
    for (let i = 1; i < 13; i++) {
...
var _SolarHalfYear = class _SolarHalfYear extends AbstractTyme {
...
var _SolarSeason = class _SolarSeason extends AbstractTyme {
  constructor(year, index) {
    super();
    __publicField(this, "year");
    __publicField(this, "index");
...
var _SolarMonth = class _SolarMonth extends AbstractTyme {
  constructor(year, month) {
    super();
    __publicField(this, "year");
    __publicField(this, "month");
...
var _SolarWeek = class _SolarWeek extends AbstractTyme {
  constructor(year, month, index, start) {
    super();
    __publicField(this, "month");
    __publicField(this, "index");
  ...
  getIndexInYear() {
    ...
    let w = _SolarWeek.fromYm(this.getYear(), 1, 0, this.start.getIndex());
  ...
  getName() {
    return _SolarWeek.NAMES[this.index];
  }
  toString() {
    return this.month.toString() + this.getName();
  }
...
var _SolarDay = class _SolarDay extends AbstractTyme {
  constructor(year, month, day) {
    super();
    __publicField(this, "month");
    __publicField(this, "day");
  ...
  getName() {
    return _SolarDay.NAMES[this.day - 1];
  }
  toString() {
    return this.month.toString() + this.getName();
  }
  ...
  getSolarWeek(start) {
    const y = this.getYear();
    const m = this.getMonth();
    return SolarWeek.fromYm(y, m, Math.ceil((this.day + _SolarDay.fromYmd(y, m, 1).getWeek().next(-start).getIndex()) / 7) - 1, start);
  }
  getPhenologyDay() {
...
var SolarTime = class _SolarTime extends AbstractTyme {
  constructor(year, month, day, hour, minute, second) {
    super();
    __publicField(this, "day");
    __publicField(this, "hour");
    ...
    const m = _SolarTime.numeric(minute, "minute");
    if (m < 0 || m > 59) {
      throw new Error(`illegal minute: ${minute}`);
    }
  ...
  next(n) {
    if (n == 0) {
      return _SolarTime.fromYmdHms(this.getYear(), this.getMonth(), this.getDay(), this.hour, this.minute, this.second);
    }
...
var _LegalHoliday = class _LegalHoliday extends AbstractTyme {
...
var _SolarFestival = class _SolarFestival extends AbstractTyme {
...
var _LunarFestival = class _LunarFestival extends AbstractTyme {
  ...
  static fromYmd(year, month, day) {
    ...
    while (matcher = reg.exec(_LunarFestival.DATA)) {
      const data = matcher[0];
      const solarTerm = SolarTerm.fromIndex(year, parseInt(data.substring(4), 10));
      const lunarDay = solarTerm.getSolarDay().getLunarDay();
      if (lunarDay.getYear() === year && lunarDay.getMonth() === month && lunarDay.getDay() === day) {
        return new _LunarFestival(1, lunarDay, solarTerm, data);
      }
    }
...
var EightChar = class extends AbstractCulture {
  constructor(year, month, day, hour) {
    super();
    __publicField(this, "threePillars");
    __publicField(this, "hour");
  ...
  getOwnSign() {
    let m = this.getMonth().getEarthBranch().getIndex() - 1;
    if (m < 1) {
      m += 12;
    }
  ...
  getBodySign() {
    let offset = this.getMonth().getEarthBranch().getIndex() - 1;
    if (offset < 1) {
      offset += 12;
    }
...
var _ChildLimit = class _ChildLimit {
...
var _KitchenGodSteed = class _KitchenGodSteed extends AbstractCulture {
  constructor(lunarYear) {
    super();
    __publicField(this, "firstDaySixtyCycle");
...
__publicField(_KitchenGodSteed, "NUMBERS", ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"]);
var KitchenGodSteed = _KitchenGodSteed;
...
var RabByungYear = class _RabByungYear extends AbstractTyme {
  constructor(rabByungIndex, sixtyCycle) {
    super();
    __publicField(this, "rabByungIndex");
    __publicField(this, "sixtyCycle");
  ...
  static fromYear(year) {
    ...
    return new _RabByungYear(Math.floor((y - 1024) / 60), SixtyCycle.fromIndex(y - 4));
  }
  static fromElementZodiac(rabByungIndex, element, zodiac) {
    for (let i = 0; i < 60; i++) {
      ...
      if (sixtyCycle.getEarthBranch().getZodiac().equals(zodiac) && sixtyCycle.getHeavenStem().getElement().getIndex() == element.getIndex()) {
        return new _RabByungYear(rabByungIndex, sixtyCycle);
      }
    }
...
var _RabByungMonth = class _RabByungMonth extends AbstractTyme {
  ...
  static fromYm(year, month) {
    return new _RabByungMonth(RabByungYear.fromYear(year), month);
  }
  static fromElementZodiac(rabByungIndex, element, zodiac, month) {
    return new _RabByungMonth(RabByungYear.fromElementZodiac(rabByungIndex, element, zodiac), month);
  }
  getRabByungYear() {
    return this.year;
  }
...
__publicField(_RabByungMonth, "DAYS", {});
__publicField(_RabByungMonth, "NAMES", ["正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]);
__publicField(_RabByungMonth, "ALIAS", ["神变月", "苦行月", "具香月", "萨嘎月", "作净月", "明净月", "具醉月", "具贤月", "天降月", "持众月", "庄严月", "满意月"]);
__publicField(_RabByungMonth, "isInit", false);
var RabByungMonth = _RabByungMonth;
var _RabByungDay = class _RabByungDay extends AbstractTyme {
  constructor(month, dayNum) {
    super();
    __publicField(this, "month");
    __publicField(this, "day");
    __publicField(this, "leap");
    const day = _RabByungDay.numeric(dayNum, "rab-byung day");
  ...
  static fromYmd(year, month, day) {
    return new _RabByungDay(RabByungMonth.fromYm(year, month), day);
  }
  static fromElementZodiac(rabByungIndex, element, zodiac, month, day) {
    return new _RabByungDay(RabByungMonth.fromElementZodiac(rabByungIndex, element, zodiac, month), day);
  }
  static fromSolarDay(solarDay) {
...
__publicField(_RabByungDay, "NAMES", ["初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十", "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十", "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十"]);
var RabByungDay = _RabByungDay;

// node_modules/@ziweijs/core/dist/index.js
...
var _stemKeys = Object.keys(zh_CN.stem);
var _branchKeys = Object.keys(zh_CN.branch);
var _fiveElementNumValue = [
  3,
  4,
  2,
  5,
...
var _fiveElementNumMaps = Object.keys(zh_CN.fiveElementNum).reduce((result, key, index) => {
  result[key] = _fiveElementNumValue[index];
  return result;
}, {});
var _selfTransformation = [
  "CP",
  "CF"
];
var _genders = Object.keys(zh_CN.gender);
var _genderMap = {
  female: 0,
  male: 1
};
...
var _one = Object.keys(zh_CN.one);
var _palaceKeys = Object.keys(zh_CN.palace);
var _fiveElementKeys = Object.keys(zh_CN.fiveElementNum);
var _transformationKeys = Object.keys(zh_CN.transformation);
var _hourRanges = [
  "23:00~12:59",
  "01:00~02:59",
  "03:00~04:59",
...
function calculateHoroscope(palaces, birthYearBranchKey, birthYear, index) {
  if (void 0 === index) {
    ...
    const lunisolarDate = calculateLunisolarDateBySolar(/* @__PURE__ */ new Date());
...
function calculateTrueSolarTime(date, longitude, timezoneOffsetHours = -date.getTimezoneOffset() / 60) {
  ...
  const localTime = new Date(date.getTime() + 6e4 * timezoneOffsetMinutes);
  const startOfYear = Date.UTC(localTime.getUTCFullYear(), 0, 0);
  const dayOfYear = Math.floor((localTime.getTime() - startOfYear) / 864e5);
  const minutesPastMidnight = 60 * localTime.getUTCHours() + localTime.getUTCMinutes() + localTime.getUTCSeconds() / 60 + localTime.getUTCMilliseconds() / 6e4;
  ...
  return new Date(date.getTime() + 6e4 * correctionMinutes);
}
...
function getSolarDateText(date) {
  if (date instanceof SolarTime) {
    ...
    return `${date.getYear()}-${_array2[0]}-${_array2[1]} ${_array2[2]}:${_array2[3]}`;
  }
  const _array = [
    date.getMonth() + 1,
    date.getDay(),
...
export {
  ...
  _hourRanges,
  _languages,
  constants_minorStars as _minorStars,
  _one,
  _palaceKeys,
  _selfTransformation,
  _stemKeys,
  ...
  getMonthlyStemsAndBranches,
  getSolarDateText,
  getStemAndBranchByYear,
  src_i18n as i18n,
  ziwei_namespaceObject as ziwei
};
//# sourceMappingURL=@ziweijs_core.js.map
