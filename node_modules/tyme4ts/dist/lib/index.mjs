...
class ShouXingUtil {
  ...
  static calcShuo(jd) {
    ...
    if (jd < f1 || jd >= f3) {
      ...
      const n = ShouXingUtil.SB.charCodeAt(Math.floor((jd - f2) / 29.5306));
  ...
  static calcQi(jd) {
    ...
    if (jd < f1 || jd >= f3) {
      ...
      const n = ShouXingUtil.QB.charCodeAt(Math.floor((jd - f2) / 365.2422 * 24));
      if (49 === n) {
        d += 1;
      } else if (50 === n) {
        d -= 1;
    ...
    if (matcher) {
      ...
      switch (type) {
        ...
        case 1:
          ...
          return new LunarFestival(1 /* TERM */, solarTerm.getSolarDay().getLunarDay(), solarTerm, data);
        case 2:
