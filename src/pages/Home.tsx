...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!sessionStorage.getItem('yyy_notice_seen')) {
      setNoticeOpen(true);
    }
  }, []);
  ...
  const closeNotice = () => {
    setNoticeOpen(false);
    sessionStorage.setItem('yyy_notice_seen', '1');
  };
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* 首页公告弹窗：清醒提示 */}
      <Modal
        title={<span style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-title)' }}>📜 命运这场开卷考，答案仅供参考</span>}
        open={noticeOpen}
        onOk={closeNotice}
